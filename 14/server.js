...
app.get("/api/faculties", jsonParser, function(request, response) {
  connection
    .then(pool => {
      return pool.query(`select * from faculty`);
    })
    .then(result => {
...
app.get("/api/pulpits", jsonParser, function(request, response) {
  connection
    .then(pool => {
      return pool.query(`select * from pulpit`);
    })
    .then(result => {
      console.log(result.recordset);
      response.send(result.recordset);
...
app.get("/api/auditoriumstypes", jsonParser, function(request, response) {
  connection
    .then(pool => {
      return pool.query(`select * from auditorium_type`);
    })
    .then(result => {
      console.log(result.recordset);
      response.send(result.recordset);
...
app.get("/api/auditorims", jsonParser, function(request, response) {
  connection
    .then(pool => {
      return pool.query(`select * from auditorium`);
    })
    .then(result => {
      console.log(result.recordset);
      response.send(result.recordset);
...
app.put("/api/faculties", jsonParser, function(request, response) {
  connection
    .then(pool => {
      return pool.query(
        `UPDATE faculty SET faculty_name='${request.body.faculty_name}'
...
app.put("/api/pulpits", jsonParser, function(request, response) {
  connection
    .then(pool => {
      return pool.query(
        `UPDATE pulpit SET pulpit_name='${request.body.pulpit_name}'
...
app.put("/api/subjects", jsonParser, function(request, response) {
  connection
    .then(pool => {
      return pool.query(
        `UPDATE subject SET subject_name='${request.body.subject_name}'
...
app.put("/api/auditoriumstypes", jsonParser, function(request, response) {
  connection
    .then(pool => {
      return pool.query(
        `UPDATE auditorium_type SET auditorium_typename='${
          request.body.auditorium_typename
        }'
...
app.put("/api/auditoriums", jsonParser, function(request, response) {
  connection
    .then(pool => {
      return pool.query(
        `UPDATE auditorium SET auditorium_capacity='${
          request.body.auditorium_capacity
        }'
